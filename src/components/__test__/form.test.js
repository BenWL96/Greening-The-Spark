...
it("Test loading game text exists", () => {
    ...
    render(<Form dataBeingFetchedAndPageLoading={dataBeingFetchedAndPageLoading}/>);
...
it("Test success or failure messages do not exists", () => {
    const dataBeingFetchedAndPageLoading = false;
    render(<Form dataBeingFetchedAndPageLoading={dataBeingFetchedAndPageLoading}/>);
    const successOrFailuremessages = screen.queryByTestId("section_body_form_message");

...
const infoPanelData = [
    ...
    },
    {
        ...
        "question": "Question 3",
        "the_simple_answer": "Answer 1",
        "the_gts_answer": "GTS tries to model ThisGTS tries to model ThisGTS tries to model ThisGTS tries to model ThisGTS tries to model ThisGTS tries to model ThisGTS tries to model ThisGTS tries to model ThisGTS tries to model This GTS tries to model ThisGTS tries to model ThisG",
